...
export default function StudentDetailSheet({ student, isOpen, onClose }: StudentDetailSheetProps) {
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
        ...
        // Usar JPEG com compressão para reduzir o tamanho do ficheiro
        const imgData = canvas.toDataURL('image/jpeg', 0.9); // 0.9 é um bom nível de qualidade
        ...
        // A imagem deve preencher a largura do PDF
        ...
        // Caso o conteúdo seja maior que uma página A4 (improvável para este layout)
        while (heightLeft >= 0) {
