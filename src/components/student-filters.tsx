...
export default function StudentFilters({ onFilterChange }: StudentFiltersProps) {
  ...
  const series = useMemo(() => ["INFANTIL II", "INFANTIL III", "INFANTIL IV", "INFANTIL V", "1º ANO", "2º ANO", "3º ANO", "4º ANO", "5º ANO"], []);
  const turnos = useMemo(() => ["MANHÃ", "TARDE"], []);
  const classes = useMemo(() => ["A", "B", "U"], []);
