    ...
    <Table>
      ...
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="text-center font-bold text-foreground">Etapa 1</TableHead>
          <TableHead className="text-center font-bold text-foreground">Etapa 2</TableHead>
          <TableHead className="text-center font-bold text-foreground">Etapa 3</TableHead>
          <TableHead className="text-center font-bold text-foreground">Etapa 4</TableHead>
          <TableHead className="text-center font-bold text-foreground">Média</TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
