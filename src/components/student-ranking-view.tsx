    ...
    return (
        <Tabs defaultValue="fund1" className="w-full">
            ...
            <TabsContent value="fund1" className="mt-6 space-y-4">
                ...
                <RankingTable title="Ranking Fundamental I" students={fundamental1.filter(s => (filtersFund1.serie === 'all' || s.serie === filtersFund1.serie) && (filtersFund1.classe === 'all' || s.classe === filtersFund1.classe) && (filtersFund1.turno === 'all' || s.turno === filtersFund1.turno))} isLoading={isLoading} />
            </TabsContent>
            <TabsContent value="fund2" className="mt-6 space-y-4">
                ...
                <RankingTable title="Ranking Fundamental II" students={fundamental2.filter(s => (filtersFund2.serie === 'all' || s.serie === filtersFund2.serie) && (filtersFund2.classe === 'all' || s.classe === filtersFund2.classe) && (filtersFund2.turno === 'all' || s.turno === filtersFund2.turno))} isLoading={isLoading} />
            </TabsContent>
        </Tabs>
    );
}
